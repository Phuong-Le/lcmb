...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/lcmb/usage](https://nf-co.re/lcmb/usage)
...
```bash
nextflow run nf-core/lcmb --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run nf-core/lcmb -profile docker -params-file params.yaml
```
